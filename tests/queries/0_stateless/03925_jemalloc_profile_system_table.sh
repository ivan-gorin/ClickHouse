...
${CLICKHOUSE_CLIENT} -q "SELECT count() > 0 FROM system.jemalloc_profile SETTINGS jemalloc_profile_output_format = 'collapsed', jemalloc_profile_symbolization_mode = 'fast'";
